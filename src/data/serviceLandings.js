export const serviceLandings = {
  "AI Automation": {
    ...
    painBody:
      "Dropped leads, data re-entry, and tools that don't talk to each other eat hours every week. Hiring more people to chase the same process just scales the waste. We map the gaps, then automate the work that should already run on its own.",
    capabilitiesKicker: "What we automate",
    capabilitiesTitle: "Workflows that keep",
    capabilitiesAccent: "revenue moving",
    capabilities: [
      {
        title: "Lead routing & follow-up",
        desc: "Inbound interest hits the right person, with sequences that don't go cold overnight.",
      },
      {
    ...
    featuresTitle: "Automation you can",
    featuresAccent: "actually trust",
    features: [
      {
        kicker: "Your stack",
        title: "Connect what you already use",
        desc: "We wire your existing tools. No rip-and-replace unless something is actually missing.",
      },
      {
        kicker: "Control",
      ...
      {
        kicker: "Safety",
        title: "Fallback to a human",
        desc: "Edge cases escalate to a real person. The workflow stops instead of guessing.",
      },
      {
        kicker: "Handoff",
    ...
    outcomesTitle: "Different verticals.",
    outcomesAccent: "Different workflows.",
    outcomes: [
      {
      ...
      },
      {
        ...
        desc: "Appointment workflows and follow-ups that cut no-shows without extra front-desk hours.",
      },
      {
    ...
    process: [
      {
        step: "01",
        title: "Map",
        desc: "A working session to find what should be automated, what should stay human, and which tools already cover it.",
      },
      {
        step: "02",
        title: "Build",
      ...
      },
      {
        step: "03",
        title: "Launch",
        desc: "Your team keeps working. The automation runs in the background, then we iterate on what actually happens in production.",
      },
    ],
    compare: [
      {
        label: "Approach",
        monk11: "Workflows built around your vertical and existing tools",
        typical: "A generic chatbot or a Zap that breaks the first week",
      },
      {
        label: "When it hits an edge",
        monk11: "Human fallback and a full audit trail",
        typical: "Dead-end bot or a ticket that sits",
      },
      {
        label: "After launch",
    ...
    faqs: [
      ...
      },
      {
        ...
        accent: "get started?",
        a: "Book a short scoping call. You leave with a written plan after that session. Most automation builds kick off within a few working days of approval.",
      },
      {
  ...
  "AI Calling Agency": {
    ...
    capabilities: [
      ...
      },
      {
        ...
        desc: "Complex questions don't dead-end. The agent hands off with context, not a cold transfer.",
      },
    ],
    featuresKicker: "How it sounds and logs",
    featuresTitle: "Built to sound like",
    featuresAccent: "your business",
    features: [
      {
        kicker: "Voice",
    ...
    outcomesKicker: "Where it lands",
    outcomesTitle: "Calls that match",
    outcomesAccent: "how you sell",
    outcomes: [
      {
        vertical: "Real Estate",
    ...
    process: [
      ...
      {
        step: "03",
        title: "Transfer & iterate",
        desc: "Hot leads go to your team instantly. We tune scripts from real call outcomes, not a demo.",
      },
    ],
    compare: [
      {
        label: "Experience",
        monk11: "Conversational voice with live transfer and CRM logging",
        typical: "Hold music, keypad trees, or a bot that can't hand off",
      },
      {
      ...
      {
        label: "When it's complex",
        monk11: "Live transfer to a human with context",
        typical: "Dead-end, callback request, or a dropped call",
      },
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        accent: "complex questions?",
        a: "The agent qualifies what it can, then live-transfers to your team with context. It is designed to know when to stop.",
      },
      {
  ...
  "Web Applications": {
    ...
    capabilities: [
      ...
      {
        title: "User panel",
        desc: "Customer or staff portals with the jobs they need to finish, not a generic account page.",
      },
      {
    ...
    featuresTitle: "Designed, built,",
    featuresAccent: "and deployed",
    features: [
      {
        kicker: "Product",
      ...
      {
        kicker: "Scope",
        title: "Written plan after one session",
        desc: "A mapped product brief and a fixed proposal. No hourly surprises mid-build.",
      },
    ],
    outcomesKicker: "Where it lands",
    outcomesTitle: "Portals and dashboards",
    outcomesAccent: "for real operations",
    outcomes: [
      {
        vertical: "Real Estate",
      ...
      {
        vertical: "Healthcare",
        title: "Intake and scheduling dashboards",
        desc: "Staff and patient views that keep calendars full without a spreadsheet bottleneck.",
      },
      {
        vertical: "Manufacturing",
      ...
      {
        vertical: "FinTech",
        title: "Role-based reporting products",
        desc: "Access control and an audit trail, deployed on infrastructure you can run.",
      },
    ],
    process: [
      {
    ...
    compare: [
      {
        label: "What you get",
        monk11: "Multi-user web app: admin, user panel, roles, analytics",
        typical: "A generated landing page or a template with no real admin",
      },
      {
        label: "Delivery",
  ...
  "Mobile Applications": {
    ...
    capabilities: [
      {
        ...
        desc: "Cross-platform where it makes sense, native when the product needs it.",
      },
      {
      ...
      },
      {
        ...
        desc: "Notifications and in-app flows tied to the jobs the app is supposed to finish.",
      },
      {
    ...
    featuresTitle: "Architecture that",
    featuresAccent: "survives launch",
    features: [
      {
        kicker: "Scope",
        title: "Real user flows first",
        desc: "We cut vanity features. The first release is something people can actually complete a job in.",
      },
      {
        kicker: "Build",
      ...
      {
        kicker: "Launch",
        title: "Stores and production",
        desc: "App Store and Play Store submission, plus the backend it depends on.",
      },
      {
        kicker: "After",
    ...
    outcomesKicker: "Where it lands",
    outcomesTitle: "Apps built around",
    outcomesAccent: "the job to be done",
    outcomes: [
      {
        vertical: "Healthcare",
        title: "Booking and intake on mobile",
        desc: "Patients complete the flow on their phone so the front desk isn't the bottleneck.",
      },
      {
        vertical: "Real Estate",
      ...
      },
      {
        ...
        desc: "Manufacturing and energy teams logging work where a browser tab won't cut it.",
      },
    ],
    process: [
      {
      ...
      },
      {
        step: "02",
        title: "Build",
        desc: "Design and engineering in sprints, with APIs and the mobile client moving together.",
      },
      {
        step: "03",
        title: "Ship",
        desc: "QA on real devices, store submission, production backend, then iteration from live usage.",
      },
    ],
    compare: [
      {
        label: "Outcome",
        monk11: "Production app on the stores, with backend and handover",
        typical: "A prototype, a no-code wrapper, or a project that never submits",
      },
      {
        label: "Scope",
  ...
  "SAAS Solutions": {
    ...
    capabilities: [
      ...
      },
      {
        ...
        desc: "Your team and your customers get the right controls. Permissions are a product feature, not an afterthought.",
      },
      {
    ...
    featuresTitle: "Built to be sold,",
    featuresAccent: "not just demoed",
    features: [
      {
        kicker: "Scale",
        title: "Infrastructure sized for growth",
        desc: "Tenancy and data model chosen so you don't rebuild when the tenth customer shows up.",
      },
      {
        kicker: "Trust",
        title: "Access control and logging",
        desc: "Especially for fintech and healthcare buyers who will ask how data is isolated.",
      },
      {
        kicker: "Operate",
        title: "Admin your team can run",
        desc: "You shouldn't need an engineer for every customer change. Dashboards first, tickets second.",
      },
      {
        kicker: "Partner",
    ...
    outcomesKicker: "Where it lands",
    outcomesTitle: "Platforms around",
    outcomesAccent: "a real process",
    outcomes: [
      {
        vertical: "FinTech",
...
export const getServiceLanding = (name) => serviceLandings[name];
