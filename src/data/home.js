...
export const differentiators = [
  ...
  {
    kicker: "Clear scope",
    title: "Written plan after one working session",
    accent: "one working session",
    desc: "A short scoping call, a mapped workflow or product brief, and a fixed proposal. No hourly surprises mid-build.",
  },
  {
    kicker: "Human fallback",
    title: "Automation that knows when to stop",
    accent: "when to stop",
    desc: "Edge cases escalate to a real person. Every automated action is logged. Your team stays in control.",
  },
  {
    kicker: "One partner",
...
export const verticalCards = [
  ...
  },
  {
    ...
    desc: "Live operations dashboards and supplier workflows that stay current without spreadsheet babysitting.",
    tag: "Dashboards + Workflows",
    href: "/services/Web Applications",
  },
  {
    title: "FinTech",
