  ...
  return (
    <div className="bg-white text-ink overflow-x-hidden">
      ...
      <article className="relative pt-[8.5rem] pb-[4rem]">
        <div className="pointer-events-none absolute right-[-8%] top-[-10%] w-[36rem] h-[36rem] rounded-full bg-primary/12 blur-[140px]" />
        <div className="wrapper relative z-10 max-w-4xl">
          ...
          <p className="mt-5 text-ink/60 text-lg max-w-2xl leading-relaxed">
            {blog.excerpt}
          </p>
          <img
            src={blog.image}
            className="rounded-2xl w-full aspect-video md:aspect-[16/7] object-cover mt-10 border border-black/10"
            alt={blog.title}
          />
          ...
          <div className="mt-14 rounded-3xl border border-black/10 bg-white p-8 md:p-10 flex flex-col md:flex-row md:items-center gap-6 justify-between">
