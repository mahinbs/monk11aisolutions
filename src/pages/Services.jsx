  ...
  return (
    <div className="bg-white text-ink overflow-x-hidden">
      ...
      <section className="relative pt-[8.5rem] pb-16 overflow-hidden">
        ...
        <div className="pointer-events-none absolute left-[-10%] bottom-[-20%] w-[28rem] h-[28rem] rounded-full bg-purpleColor/10 blur-[120px]" />
        <div className="wrapper relative z-10 max-w-3xl min-h-[42vh] space-y-6">
          ...
          <h1 className="text-[2.35rem] sm:text-5xl lg:text-[4.35rem] font-bold leading-[1.05] tracking-tight">
            Five services.{" "}
            <span className="text-primary">One team that ships.</span>
          </h1>
